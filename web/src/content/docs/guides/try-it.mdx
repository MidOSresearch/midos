...
<Aside type="tip">
These examples use the Free tier (9 tools, 100 queries/month). Want full access? See [Access Tiers](/tiers/).
</Aside>

## Live Endpoint

MidOS is available at:
...
```bash
curl -s -X POST https://midos.dev/mcp \
...
| Tool | What it does |
|------|-------------|
| `search_knowledge` | Keyword search across 46,000+ knowledge chunks |
| `list_skills` | Browse 125 skills by technology stack |
...
**Want more?** The [Dev tier](/tiers/) ($20/mo) unlocks all 85 tools, full untruncated knowledge, EUREKA discoveries, semantic search, and 25,000 queries/month.
